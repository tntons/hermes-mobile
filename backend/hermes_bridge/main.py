"""Hermes Mobile Bridge — FastAPI app entry point."""
...
async def lifespan(_app: FastAPI):
    ...
    registry = init_registry(settings.runs_db_path)
...
app = FastAPI(
    ...
    description="Bearer-auth adapter between the Hermes iOS app and hermes-webui.",
    version="0.1.0",
    lifespan=lifespan,
)
