...
public enum JarvisStore {
    public static let shared: ModelContainer = {
        ...
        let config = ModelConfiguration("JARVIS", schema: schema, isStoredInMemoryOnly: false)
        do {
            ...
            do {
                ...
                return try! ModelContainer(
                    for: schema,
                    configurations: ModelConfiguration("JARVIS", isStoredInMemoryOnly: true)
                )
            }
        }
    }()
...
@MainActor
public enum JarvisDAO {
    public static let context = ModelContext(JarvisStore.shared)
